...
def enablePrivilege(priv, handle):
	...
	# Now  LUID is setup and pointing to the correct Privilege you can check to see if its enabled
	...
	#  Check pfResult to see if the Privilege is enabled or not
	if pfResult:
	...
	# Do not modify the selected Privilege in the Token
...
# Check to see if you have the Handle
if hWnd == 0:
...
# Spawn A Process As  Current User
